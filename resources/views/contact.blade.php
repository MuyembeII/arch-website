...
<div>
    ...
    @endcomponent
    <div class="relative flex py-6 justify-center md:justify-start items-top min-h-screen bg-white  lg:px-64">
        <div class="max-w-6xl  sm:px-6 lg:px-8">
            <div class="mt-8 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 bg-gray-100 sm:rounded-lg">
                        <h1 class="text-4xl sm:text-5xl text-gray-800 d font-extrabold tracking-tight">
                            Get in touch
                        </h1>
